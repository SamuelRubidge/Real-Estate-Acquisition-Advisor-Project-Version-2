...
```
    ...
    C:\Users\Administrator\AppData\Local\Temp\ipykernel_41864\825859715.py:39: FutureWarning: The default value of regex will change from True to False in a future version. In addition, single character regular expressions will *not* be treated as literal strings when regex=True.
      ZillowRentScrape['price'] = ZillowRentScrape['price'].str.replace('+', '.0')
...
```
    ...
    How many properties do you wish to graph? (1-20)10
...
for i in range(plot_amount):
    CompMapping = geopandas.read_file('geo_export_b27b312e-e7ec-4320-b924-df7eb18d80fe.shp')
...
# i
    ...
    plt.grid(linestyle='--', alpha=0.5) 
    crs = {'init': 'epsg:4326'}
    ctx.add_basemap(gax,crs=crs, source=ctx.providers.OpenStreetMap.Mapnik)
...
```
    ...
    C:\Users\Administrator\AppData\Local\Temp\ipykernel_41864\3540181295.py:16: SettingWithCopyWarning: 
    ...
    See the caveats in the documentation: https://pandas.pydata.org/pandas-docs/stable/user_guide/indexing.html#returning-a-view-versus-a-copy
      best[i] = best.apply(lambda row: CompLocater(row['latitude'], row['longitude'], row['bedrooms'], i), axis=1)
    C:\Users\Administrator\AppData\Local\Temp\ipykernel_41864\3540181295.py:23: SettingWithCopyWarning: 
    A value is trying to be set on a copy of a slice from a DataFrame.
    Try using .loc[row_indexer,col_indexer] = value instead
    
    See the caveats in the documentation: https://pandas.pydata.org/pandas-docs/stable/user_guide/indexing.html#returning-a-view-versus-a-copy
      best[i] = best[i].astype(str)
    C:\Users\Administrator\AppData\Local\Temp\ipykernel_41864\3540181295.py:24: SettingWithCopyWarning: 
    A value is trying to be set on a copy of a slice from a DataFrame.
    Try using .loc[row_indexer,col_indexer] = value instead
...
![png](output_24_5.png)
    ...
    1              1   2054.540807    1866.666667      187.874140  279812.125860   
    2              2   2054.540807    1865.414172      189.126634  279622.999225   
    3              3   2054.540807    1864.153328      190.387479  279432.611747   
    4              4   2054.540807    1862.884078      191.656729  279240.955018   
    ..           ...           ...            ...             ...            ...   
    356          356   2054.540807      67.136025     1987.404782    8082.999017   
    357          357   2054.540807      53.886660     2000.654147    6082.344871   
    358          358   2054.540807      40.548966     2013.991841    4068.353030   
    359          359   2054.540807      27.122354     2027.418453    2040.934576   
    360          360   2054.540807      13.606231     2040.934576       0.000000   
    ...
    1                           7.202947e+04     100.205984    100.327374   
    2                           7.406988e+04     100.412392    100.655820   
